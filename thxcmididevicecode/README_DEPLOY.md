...
Use this only when the board is already running CircuitPython and exposing a serial REPL. This path updates the root firmware files only and is not a replacement for first-time bootstrap provisioning.
