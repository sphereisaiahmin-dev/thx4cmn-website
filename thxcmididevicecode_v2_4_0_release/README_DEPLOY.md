...
```bash
$HOME/Library/Python/3.14/bin/ampy --port /dev/cu.usbmodem114301 put thxcmididevicecode_v2_4_0_release/protocol_v1.py /protocol_v1.py
$HOME/Library/Python/3.14/bin/ampy --port /dev/cu.usbmodem114301 put thxcmididevicecode_v2_4_0_release/code.py /code.py
$HOME/Library/Python/3.14/bin/ampy --port /dev/cu.usbmodem114301 put thxcmididevicecode_v2_4_0_release/boot.py /boot.py
